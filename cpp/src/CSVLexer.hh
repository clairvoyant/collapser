...
#undef YY_DECL
#define YY_DECL int CSV::FlexLexer::yylex()
...
namespace CSV {
	class FlexLexer : public yyFlexLexer {
		public:
			...
			int yylex(CSV::BisonParser::semantic_type * lval) { yylval = lval; return yylex(); }

			bool setParsing(bool b) { 
			   // TODO 
			}
			bool setScanning(bool b) { 
			   // TODO 
			}
		...
		private:
			...
			CSV::BisonParser::semantic_type * yylval;
	};
}
